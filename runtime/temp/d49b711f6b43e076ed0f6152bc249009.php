...
<div class="row">
	<div class="col-md-8  col-sm-8">
		<div class="page-header">
		  ...
		  <form method="post" id="login" action="<?php echo url('index/insert'); ?>" enctype="multipart/form-data">
		  <input type="hidden" name="user_id" value="<?php echo htmlentities(app('session')->get('id')); ?>">
		  <div class="form-group">
		    <label for="">文章标题</label>
		    <input type="text" name="title" required="required" class="form-control" id="" placeholder="Title">
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		    ...
		    <input name="img_title" id="file-0" class="file" type="file" multiple>
