...
<div class="row">
    <div class="col-md-8  col-sm-8">
        ...
        <div class="row">
            <div class="col-md-4">
                <a href="#"><img src="/<?php echo htmlentities($artres['img_title']); ?>" class="img-rounded" style="width: 230px;height: 150px"></a>
            </div>
            <div class="col-md-8">
                <h4><a href="<?php echo url('Index/detail?artid='.$vo['id']); ?>" class="lead"><?php echo htmlentities($artres['title']); ?></a></h4>
                <p>发布者:<mark><?php echo htmlentities(app('session')->get('username')); ?></mark></p>
                <p>时间:<?php echo htmlentities($artres['create_time']); ?></p>
                <p>阅读量:<?php echo htmlentities($artres['pv']); ?></p>
                <div class="lead"><?php echo htmlentities($artres['content']); if(strlen($vo['content'])>20){echo '...<a href="#">[全文]</a>';}?></div>
                <hr>
            </div>
        </div>
    </div>
